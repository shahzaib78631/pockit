...
CREATE TABLE items (
    ...
    barcode TEXT UNIQUE,
    name TEXT NOT NULL,
    selling_type TEXT NOT NULL DEFAULT 'whole' CHECK (selling_type IN ('unit', 'whole')),
...
CREATE TRIGGER handle_times_units
...
CREATE TRIGGER handle_times_suppliers
BEFORE INSERT OR UPDATE ON suppliers
FOR EACH ROW
EXECUTE FUNCTION handle_times();

CREATE TRIGGER handle_times_people
BEFORE INSERT OR UPDATE ON people
FOR EACH ROW
EXECUTE FUNCTION handle_times();

CREATE TRIGGER handle_times_items
