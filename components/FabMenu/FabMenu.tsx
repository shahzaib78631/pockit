...
interface FabMenuProps {
  ...
  onPress?: (expanded?: boolean) => void; // renamed from onToggle to onPress
}
 ...
 * - onPress: Callback fired when the menu state changes (expanded or collapsed).
 */
function FabMenu({
  theme,
  mainIcon,
