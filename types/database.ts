// === start of custom type ===
  ...
  export type ItemsViewPrices = Array<{
   ...
   // ItemsView.ItemsViewUnits.units
   export type ItemsViewUnits = Array<{
	id: string;
	item_id: string;
	unit_id: string;
	buying_price: number;
...
export interface ItemsViewResponse extends BaseCollectionResponse {
...
export type Schema = {
	...
	item_prices: ItemPricesCollection;
